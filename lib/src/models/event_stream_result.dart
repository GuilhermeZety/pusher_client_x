...
import 'package:pusher_client_x/src/pusher/pusher_event.dart';
...
class EventStreamResult {
  ...
  factory EventStreamResult.fromJson(Map<String, dynamic> json) => _$EventStreamResultFromJson(json);
