...
import 'package:pusher_client_x/src/contracts/stream_handler.dart';
import 'package:pusher_client_x/src/models/connection_error.dart';
import 'package:pusher_client_x/src/models/connection_state_change.dart';
import 'package:pusher_client_x/src/models/event_stream_result.dart';
...
class PusherClient extends StreamHandler {
  static const MethodChannel _channel = const MethodChannel('com.github.chinloyal/pusher_client');
